...
class Test_matrix_rotation(unittest.TestCase):
    ...
    def test_rotate_matrix_shape_degree_1_clockwise(self):
        rotated_matrix = rotate_matrix(matrix=self.matrix, degree=1, clockwise=True)
        self.assertEqual(np.array(rotated_matrix).shape, np.array(self.matrix).shape)

    
    def test_rotate_matrix_degree_1_clockwise(self):
        rotated_matrix = rotate_matrix(matrix=self.matrix, degree=1, clockwise=True)
        self.assertEqual(rotated_matrix, [['24', '1', '2', '3', '4', '5', '6'],
                                          ['23', '40', '25', '26', '27', '28', '7'],
                                          ['22', '39', '48', '41', '42', '29', '8'],
                                          ['21', '38', '47', '49', '43', '30', '9'],
    ...
    def test_rotate_matrix_shape_degree_1_anticlockwise(self):
        rotated_matrix = rotate_matrix(matrix=self.matrix, degree=1, clockwise=False)
        self.assertEqual(np.array(rotated_matrix).shape, np.array(self.matrix).shape)

    
    def test_rotate_matrix_degree_1_anticlockwise(self):
        rotated_matrix = rotate_matrix(matrix=self.matrix, degree=1, clockwise=False)
        self.assertEqual(rotated_matrix, [['2', '3', '4', '5', '6', '7', '8'],
                                          ['1', '26', '27', '28', '29', '30', '9'],
    ...
    def test_rotate_matrix_shape_any_degree_clockwise(self):
        for degree in self.degrees:
            rotated_matrix = rotate_matrix(matrix=self.matrix, degree=degree, clockwise=True)
            self.assertEqual(np.array(rotated_matrix).shape, np.array(self.matrix).shape)
    ...
    def test_rotate_matrix_any_degree_clockwise(self):
        for degree in self.degrees:
            rotated_matrix = rotate_matrix(matrix=self.matrix, degree=degree, clockwise=True)
            self.assertEqual(rotated_matrix, self.clockwise_any_degree_result_dictionary[degree])


    def test_rotate_matrix_shape_any_degree_anticlockwise(self):
        for degree in self.degrees:
            rotated_matrix = rotate_matrix(matrix=self.matrix, degree=degree, clockwise=False)
            self.assertEqual(np.array(rotated_matrix).shape, np.array(self.matrix).shape)
    ...
    def test_rotate_matrix_any_degree_anticlockwise(self):
        for degree in self.degrees:
            rotated_matrix = rotate_matrix(matrix=self.matrix, degree=degree, clockwise=False)
            self.assertEqual(rotated_matrix, self.anticlockwise_any_degree_result_dictionary[degree])
    ...
    def test_command_line_interface_matrix(self):     
        input_matrix = "[['1', '2', '3', '4', '5', '6', '7'],['24', '25', '26', '27', '28', '29', '8'],['23', '40', '41', '42', '43', '30', '9'],['22', '39', '48', '49', '44', '31', '10'],['21', '38', '47', '46', '45', '32', '11'],['20', '37', '36', '35', '34', '33', '12'],['19', '18', '17', '16', '15', '14', '13']]"
        ...
        runner = CliRunner()
        result = runner.invoke(matrix_rotation_cli.main, args=["--matrix", input_matrix])
    ...
    def test_command_line_interface_degree(self):     
        ...
        runner = CliRunner()
        result = runner.invoke(matrix_rotation_cli.main, args=["--matrix", input_matrix, "--degree", 5])
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_matrix in result.output)
    ...
    def test_command_line_interface_clockwise(self):     
        ...
        runner = CliRunner()
        result = runner.invoke(matrix_rotation_cli.main, args=["--matrix", input_matrix, "--degree", 3, "--clockwise", False])
        print(result.output)
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_matrix in result.output)
...
[['21', '22', '23', '24', '1', '2', '3'], ['20', '37', '38', '39', '40', '25', '4'], ['19', '36', '45', '46', '47', '26', '5'], ['18', '35', '44', '49', '48', '27', '6'], ['17', '34', '43', '42', '41', '28', '7'], ['16', '33', '32', '31', '30', '29', '8'], ['15', '14', '13', '12', '11', '10', '9']]"""
        runner = CliRunner()
        result = runner.invoke(matrix_rotation_cli.main, args=["--matrix", input_matrix, "--degree", 4, "--clockwise", True, "--print_matrix", True])
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_matrix in result.output)
